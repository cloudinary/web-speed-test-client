...
!(function (e, t) {
  ...
  function r(t, r) {
    ...
    e(t, r) &&
      ((a = s.replace(' ' + r + ' ', ' ')),
      (t.className = a.substring(1, a.length - 1)));
  }
  function n(e) {
  ...
  var s = {};
  (s.defaults = { category: 'default', speed: 2e3 }),
    (s.start = function (e) {
      (this.options = o(s.defaults, e)),
        (this.wdtLoadingScreen = document.querySelector('.wdt-loading-screen'));
      for (
        var t = document.querySelectorAll('.wdt-loading-phrase-category'),
          r = 0;
        r < t.length;
        r++
      )
      ...
      (this.wdtPhraseActiveCat = document.querySelector(
        ...
        i(this.wdtPhraseActiveCat, { display: 'block' }),
      ...
      for (var n = [], r = 0; r < this.activePhrases.length; r++)
        n.push(this.activePhrases[r]), a(this.activePhrases[r]);
      n = s.shuffle(n);
      for (var r = 0; r < n.length; r++)
        this.wdtPhraseActiveCat.appendChild(n[r]);
      return i(this.wdtLoadingScreen, { display: 'block' }), s.spin(), this;
    }),
    (s.spin = function () {
      var e = this;
      (this.phraseHeight = e.wdtPhraseActiveCat.querySelector(
        '.wdt-loading-phrase'
      ).scrollHeight),
        (e.currentIndex = 0),
        (e.currentTransform = 0),
        (e.spinInternal = setInterval(function () {
          if (
            ((e.activePhrases = e.wdtPhraseActiveCat.querySelectorAll(
              '.wdt-loading-phrase'
            )),
            t(e.activePhrases[e.currentIndex], 'wdt-checked'),
            e.currentIndex++,
            (e.currentTransform = e.currentTransform - e.phraseHeight),
            i(e.wdtPhraseActiveCat, {
            ...
            var n = e.activePhrases[e.currentIndex - 2],
              a = n.cloneNode(!0);
            r(a, 'wdt-checked'),
              t(a, 'wdt-cloned-phrase'),
              (a.style.transform = ''),
              e.wdtPhraseActiveCat.appendChild(a);
          }
        }, this.options.speed));
    }),
    (s.done = function () {
      this.spinInternal && clearInterval(this.spinInternal),
        i(this.wdtLoadingScreen, { display: 'none' });
      for (
        var e = document.querySelectorAll('.wdt-cloned-phrase'),
          t = document.querySelectorAll('.wdt-loading-phrase'),
          n = 0;
        n < t.length;
        n++
      )
  ...
  var o = function () {
    ...
    i = (function () {
      ...
      function t(e) {
        ...
        if (e in t) return e;
        for (
          var r, n = a.length, s = e.charAt(0).toUpperCase() + e.slice(1);
          n--;
      ...
      return function (e, t) {
        ...
        if (2 == s.length)
          for (r in t)
            (a = t[r]), void 0 !== a && t.hasOwnProperty(r) && n(e, r, a);
        else n(e, s[1], s[2]);
      };
    })();
  return s;
