...
export default class ResultSumm extends Component {
  ...
  render() {
    ...
    let url2png;
    if (result.url) {
      url2png = cloudinaryCore.url(result.url.replace(/\/$/, ""), { width: 300, crop: 'limit', type: "url2png", fetchFormat: "jpg", dpr: "auto" }) + "/url2png/fullpage=false%7Cviewport=" + result.viewportSize.width + "x2200%7Cthumbnail_max_width=900";
    }
