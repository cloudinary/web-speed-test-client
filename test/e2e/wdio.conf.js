...
exports.config = {
  ...
  //
  // specs: ['./lib/test/**/*Test.js'],
  suites: {
    speedTestSuite: ["./lib/specs/WebSpeedTest.js"]
  },
  // Patterns to exclude.
  exclude: [
  ...
  // baseUrl: 'www.staging.cloudinary.com',
  //
...
// Default request retries count
  ...
  afterTest: function(test) {
    ...
    if (!test.passed) {
      /**
       * write browser console logs after each test to reporter
       */
      ...
      /**
       * Get html source and attach it to report
       */
      wdioAllureReporter.createStep(
        "Page HTML source",
        `${browser.getSource()}`,
